...
public:
    ...
    void render(glm::mat4 &view, glm::mat4 &projection, glm::vec3 lightPos, glm::vec3 lightColor, glm::vec3 pointLightPos, int isPointLightOn, float intensity, Shader *shader);
